...
import app.interfold.app.api.model.BareSystem
import app.interfold.app.api.model.CustomField
import app.interfold.app.api.model.FriendFrontingAlter
import app.interfold.app.api.model.FriendRequestData
import app.interfold.app.api.model.Friendship
import app.interfold.app.api.model.GlobalJournalEntry
...
import app.interfold.app.utils.idRegex
import app.interfold.app.utils.ioDispatcher
import app.interfold.app.utils.platformLog
import app.interfold.kotlix.Channel
import app.interfold.kotlix.Message
import app.interfold.kotlix.Payload
import app.interfold.kotlix.Socket
import app.interfold.kotlix.SocketEvent
import app.interfold.kotlix.SocketFlow
import app.interfold.kotlix.ktor.KtorWebSocketTransport
 ...
 * [app.interfold.app.ui.model.interfaces.ApiInterfaceImpl] can be exercised
...
internal class KotlixPhoenixSocketSession(
  ...
  private var socket: Socket = Socket(
    ...
    logger = if (BuildConfig.isDebug()) {
      {
        platformLog("INTERFOLD-CHANNEL", it)
      }
    } else null
  }
...
/**
 * Sends a PUT request to the Interfold API.
 *
...
suspend fun fetchAndroidFirebaseConfig(endpoint: String): APIResponse<app.interfold.app.utils.FirebaseConfig.Android> =
  get(endpoint, null, "settings/firebase-config?platform=android").body<APIResponse<app.interfold.app.utils.FirebaseConfig.Android>>()

suspend fun fetchIOSFirebaseConfig(endpoint: String): APIResponse<app.interfold.app.utils.FirebaseConfig.IOS> =
  get(endpoint, null, "settings/firebase-config?platform=ios").body<APIResponse<app.interfold.app.utils.FirebaseConfig.IOS>>()

suspend fun fetchWebFirebaseConfig(endpoint: String): APIResponse<app.interfold.app.utils.FirebaseConfig.Web> =
  get(endpoint, null, "settings/firebase-config?platform=web").body<APIResponse<app.interfold.app.utils.FirebaseConfig.Web>>()
