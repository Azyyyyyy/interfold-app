...
When we say "Team," “we”, “our”, or “us” in this document, we are referring to Azyyyyyy, the current maintainer of Interfold.

When we say “Services”, we mean this website and any product I maintain.
...
transmission where applicable. On-device activity and any optional export you enable are described in our
...
to share with us. Legal process about instance data should be directed to the instance operator. We do not
receive crash reports from the app. We will only preserve or share information we ourselves hold if compelled
by a US government authority with a legally binding order, or as otherwise required by applicable law.
5. We may use third party vendors for this website and related technology required to distribute the Services.
Only vendors listed explicitly under our Privacy Policy may have very limited access to personal data we
ourselves collect. The app does not send activity or crash data to a vendor on our behalf.
